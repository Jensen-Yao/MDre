...
<p align="center">
  <strong>轻量、直接、本地优先的 Markdown / HTML 日常阅读器</strong>
</p>
...
MDre 是一款面向 Windows、Android 和 Linux x64 的轻量级 Markdown / HTML 阅读器，用于快速打开、阅读和简单编辑本地文档。

本软件参考了市面上常见 MD 阅读器软件的功能取舍，比如 Obsidian 的基础阅读功能，开发了一个更轻量、更直接的日常阅读工具。

## 功能特点

- 支持 `.md`、`.markdown`、`.txt`、`.html`、`.htm` 等常见文档。
- 支持 Markdown 表格、任务列表、代码高亮、公式、Mermaid 图和本地图片。
- 支持 HTML 静态页面预览，并识别常见 Mermaid 片段。
- 支持文档搜索、标题导航、最近文件、页面颜色切换和预览态简易编辑。
- 支持 Android 文件管理器打开、系统分享打开和文件转发分享。
- 本地优先，无账号要求，无遥测。
- Android 安装包约 5 MB，适合日常轻量阅读。

## 下载

请前往 Releases 页面下载最新版：

- [Windows 安装包](https://github.com/Jensen-Yao/MDre/releases)
