...
本软件参考了市面上常见 MD 阅读器软件的功能取舍，比如 Obsidian 的基础阅读编辑功能，开发了一个更轻量、更直接的日常阅读工具。
...
- 超出普通katex公式渲染，实际使用可渲染复杂公式的能力 超过 VScode 原生渲染
- 支持 HTML 静态页面预览，并识别常见 Mermaid 片段。
- 支持文档内搜索、标题导航、最近文件和页面颜色切换。
- 本地优先，无账号要求，无遥测。     
- 安卓端的极致轻量化，Android 版本安装包仅约 5MB。
